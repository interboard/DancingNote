		...
		var responder:Responder;//宣告 Responder物件
				...
				connection.call("readnote.readline_high",responderlineH,songname);
				connection.call("readnote.readline_low",responderlineL,songname);

				connection.call("readnote.readpage_high",responderpageH,songname);
				connection.call("readnote.readpage_low",responderpageL,songname);

				connection.call("readnote.readnote_high",responderhigh,songname);
				connection.call("readnote.readnote_low",responderlow,songname);
				
				connection.call("readnote.readkey",responderkey,songname);
				connection.call("readnote.readspeed",responderspeed,songname);

				connection.call("readnote.readeight",respondereight,songname);
				connection.call("readnote.readslur",responderslur,songname);
